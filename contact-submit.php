...
if($_POST)
{
    $to_Email   	= "fargadesachin46@gmail.com"; //Replace with recipient email address
    $subject        = 'Inaya Financial Consultancy & Research  - New Contact Inquiry'; //Subject line for emails
