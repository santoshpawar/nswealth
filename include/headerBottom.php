                ...
                <div class="col-md-8 col-sm-8 col-xs-12 text-right p-0">
                    <div class="header-top-links">
                        <div class="social-icons text-right">
                            <ul>
                                <li><a href="https://www.facebook.com/NSwealth" target="_blank"><i aria-hidden="true" class="fa fa-facebook"></i></a></li>
                    ...
                    <div class="cont_office">
                        <div class="office_menu">
                             <a href="health.php" class="healthCheck" >Health Checkup</a> 
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="bg-white row">
                <div class="col-md-3 col-sm-3 col-xs-12" style="margin-top: -20px">
                    <a href="index.php"><img src="images/nswealth.png" alt="logo" /></a>
                </div>
                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="addressbox" data-office="pune">
                        <div class="get-tuch text-left"><i class="icon-telephone114 color_red"></i>
                            <ul>
                                <li>
                                    <h4>9145354545  </h4>
                    ...
                    <div class="addressbox" data-office="karad">
                        <div class="get-tuch text-left"><i class="icon-telephone114 color_red"></i>
                            <ul>
                                <li>
                                    <h4>02164221545</h4>
